CREATE DATABASE `jobportaltest1`;
...
CREATE TABLE  `job_applicant` (
  ...
  KEY `job_applicant_key` (`job_id`),
  CONSTRAINT `id_post_jobapplicant` FOREIGN KEY (`job_id`) REFERENCES `job` (`id`),
  CONSTRAINT `is_applicant_jobapplicant` FOREIGN KEY (`applicant_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
