	 ...
	 public static class EmployerSecurityConfig extends WebSecurityConfigurerAdapter {
		 ...
		 protected void configure(HttpSecurity http) throws Exception{
			 http
			   ...
			   .antMatchers("/user/employer/jobposting/**").hasAuthority("EMPLOYER")
			   .antMatchers("/user/employer/jobpostings/**").hasAuthority("EMPLOYER")
	 ...
	 public static class ApplicantSecurityConfig extends WebSecurityConfigurerAdapter {
		 ...
		 protected void configure(HttpSecurity http) throws Exception{
		  http
		   ...
		   .antMatchers("/user/applicant/jobposting/**").hasAuthority("APPLICANT")
		   .antMatchers("/user/applicant/jobpostings/**").hasAuthority("APPLICANT")
